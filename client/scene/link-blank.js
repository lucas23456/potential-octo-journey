AFRAME.registerComponent('link_blank', {
  ...
  init: function () {
    ...
    this.quaternionClone = new AFRAME.THREE.Quaternion();
   ...
   */
  tick: (function () {
    var cameraWorldPosition = new AFRAME.THREE.Vector3();
    var elWorldPosition = new AFRAME.THREE.Vector3();
  ...
  calculateCameraPortalOrientation: (function () {
    var mat4 = new AFRAME.THREE.Matrix4();
    var cameraPosition = new AFRAME.THREE.Vector3();
    var portalNormal = new AFRAME.THREE.Vector3(0, 0, 1);
    var portalPosition = new AFRAME.THREE.Vector3(0, 0, 0);
